      ...
      ratings: [
        {
          ...
          customer_name: "মিজান",
          content:
            "অফিসিয়াল ট্যুর এর জন্যে ২০০ পিস টি-শার্ট দরকার ছিলো। বিডো তে ডিমান্ড করার সাথে সাথে অনেক প্রফেশনাল সেলার থেকে আমি রেস্পন্স পাই ।",
          image: "1.jpg",
        },
        {
          id: 2,
          customer_name: "ইমরান",
          content: "অনেক প্রফেশনাল সার্ভিস । বাংলাদেশের প্রেক্ষাপটে এইরকম একটা ওয়েবসাইট সবার খুব কাজে আসবে। বিডো এখানকার বাজার ব্যবস্থার চেহারা পাল্টে দিতে পারে।",
          image: "2.jpg",
        },

        {
          ...
          customer_name: "তুহিন",
          content:
            "আমি বিডোর ১জন সেলার। আগের থেকে কাস্টমার খুজে নেওয়া এখন অনেক সহজ হয়ে গেছে । ব্যবসা হাতের মুঠোয় মনে হচ্ছে । ধন্যবাদ বিডো।",
          image: "3.jpg",
        },
      ],
    };
