          ...
          <div class=" col-lg-6 col-sm-12 col-xs-12 col-md-6 offset-lg-1 order-1 order-md-6">
            ...
            <div class="content mb-30">
                ...
                <div class="des">
                    ...
                    <p>বিড করা সেলারদের থেকে যাদের প্রোডাক্ট বা সার্ভিস আপনার পছন্দ হয়, তাদেরকে শর্ট লিস্ট করুন এবং পরে একজনকে কনফার্ম করুন। অথবা চাইলে সরাসরি একজনকে কনফার্ম করে দিতে পারেন।</p>
                </div>
            </div> <!--end content-->
            <div class="content mb-30">
