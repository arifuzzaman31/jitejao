        ...
        <div class="col-md-12">
          ...
          <div class="terms">
            ...
            <div class="details  pt-10">
              ...
              <p> মজার ব্যাপার হলো <a href="jitejao.com">jitejao.com</a> এ সবাই কাস্টমার আবার সবাই সেলার। অর্থাৎ এক একাউন্টেই ডিমান্ড পোস্ট ও করতে পারবে আবার অন্যের পোস্টে বিড ও করতে পারবে।</p>
            </div>
          </div>
          ...
          <div class="terms">
            ...
            <div class="details  pt-10">
              <p><a href="jitejao.com">jitejao.com</a> এমন একটা প্লাটফর্ম যেখানে একজন কাস্টমার নিজের যে কোনো প্রয়োজনীয় প্রোডাক্টের জন্য পোস্ট করতে পারে। সেটা নতুন ও হতে পারে আবার পুরোনো ও হতে পারে। খুচরা ও হতে পারে আবার পাইকারি ও হতে পারে। </p> 
          ...
          <div class="terms">
            ...
            <div class="details  pt-10">
              <p><a href="jitejao.com">jitejao.com</a> এ সব ইউজারই ভেরিফায়েড। নিজের নাম্বার দিয়ে রেজিস্ট্রেশন এবং লগইন করার পর একজন ইউজার ভেরিফায়েড হয়ে যাবে। ভেরিফায়েড হওয়ার সময় তিনি সিলভার ব্যাজ পাবেন। এরপর ১০ টি পোস্ট কমপ্লিট হলে পাবেন গ্রীন ব্যাজ। আবার সবমিলিয়ে ৩০ টি পোস্ট কমপ্লিট হলে পাবেন  পিঙ্ক ব্যাজ।</p>
          ...
          <div class="terms">
            ...
            <div class="details  pt-10">
              <p> <a href="jitejao.com">jitejao.com</a> এ সারা মাস আনলিমিটেড বিড করতে হলে সাবস্ক্রিপশন কিনতে হবে। ৩০ টাকায় ১ মাস। এছাড়া আরও কিছু প্যাকেজ রয়েছে। তবে রেজিস্ট্রেশন করলেই প্রথম মাস সাবস্ক্রিপশন ফ্রি।</p>
            </div>
          </div>
